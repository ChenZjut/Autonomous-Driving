...
int main(int argc, char **argv)
{
    ...
    ros::Subscriber sub_points = nh.subscribe("/ray_filter/velodyne_points_costmap", 10, pointsCB);
    ros::Subscriber sub_cur_pose = nh.subscribe("/current_pose", 50, poseCB);
    ros::Subscriber sub_global_costmap = nh.subscribe("/global_costmap", 1, globalCostmapCB);
