...
void TrajectoryGen::TrajectoriesToMarkers(const std::vector<std::vector<yunle_msgs::WayPoint>> &paths, 
...
void TrajectoryGen::TrajectoriesSpeedToMarkers(const std::vector<std::vector<yunle_msgs::WayPoint>> &paths, 
										  visualization_msgs::MarkerArray &markerArray, 
										  const TrajectoryCost &tc)
{
